...
namespace Stump.Server.WorldServer.Database.Npcs.Replies
{
    ...
    public class PrestigeReply : NpcReply
    {
        ...
        public override bool Execute(Npc npc, Character character)
        {
            ...
            {
                character.OpenPopup("Necesitas ser nivel 200 para incrementar tu Prestigio.");
            }
            
            if (character.PrestigeRank  == 10)
            {
                character.OpenPopup("Has Completado todos tus prestigios. Ahora eres uno de los seres más poderosos del Servidor. ");
            }
