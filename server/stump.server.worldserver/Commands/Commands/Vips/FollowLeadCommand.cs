...
namespace Stump.Server.WorldServer.Commands.Commands
{
    public class FollowLeadCommand : InGameCommand
    {
        ...
        {
            Aliases = new[] { "seguir","follow" };
            Description = "Permite que tus personajes secundarios te sigan.";
        ...
        public override void Execute(GameTrigger trigger)
        {
            ...
            if (!character.isMultiLeadder)
            {
                ...
                character.SendServerMessage("El seguimiento de los personajes está ahora habilitado, todos tus personajes se unirán automáticamente al combate y se moverán con el líder !");
            }
            else
            {
                ...
                character.EnterFight -= OnEnterFight;
                character.ReadyStatusChanged -= OnReadyStatusChanged;
                character.SendServerMessage("El seguimiento de los personajes está desactivado !");
            }
        }
