...
namespace Stump.Server.WorldServer.Commands.Commands.Teleport
{
    class Nawidad : CommandBase
    {
        ...
        public Nawidad()
        {
            Aliases = new[] { "nawidad", "navidad" };
            RequiredRole = RoleEnum.Player;
            Description = "Transporta al evento de Nawidad.";
        }
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            if (gameTrigger != null)
            {
                ...
                Teleport(player, 66062340, 245, DirectionsEnum.DIRECTION_NORTH);
            }
