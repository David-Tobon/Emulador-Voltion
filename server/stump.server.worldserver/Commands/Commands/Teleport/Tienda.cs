...
{
    class TeleportShop : CommandBase
    {
        ...
        public TeleportShop()
        {
            Aliases = new[] { "tienda", "shop", "boutique" };
            RequiredRole = RoleEnum.Player;
            Description = "Transporta a la tienda principal del Servidor";
        }
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            if (gameTrigger != null)
            {
                ...
                Teleport(player, 196215812, 444, DirectionsEnum.DIRECTION_SOUTH_EAST);
            }
        }
    }
}