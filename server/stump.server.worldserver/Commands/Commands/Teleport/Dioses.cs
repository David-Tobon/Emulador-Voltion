...
namespace Stump.Server.WorldServer.Commands.Commands.Teleport
{
    class Dioses : CommandBase
    {
        ...
        public Dioses()
        {
            Aliases = new[] { "dioses","dios"};
            RequiredRole = RoleEnum.Player;
            Description = "Transporta a la zona de los Dioses.";
        }
        ...
        public override void Execute(TriggerBase trigger)
        {
            ...
            if (gameTrigger != null)
            {
                ...
                Teleport(player, 188220416, 450, DirectionsEnum.DIRECTION_SOUTH);
            }
