    ...
    public class FightAgression : Fight<FightPlayerTeam, FightPlayerTeam>
    {
        ...
        protected override List<IFightResult> GetResults()
        {
            ...
            foreach (var playerResult in results.OfType<FightPlayerResult>())
            {
                ...
                if (GetFightDuration().TotalMinutes < 2)
                {
                    ...
                    if (m_honor > 0)
                    {
                        if (m_honor > 228 / 2) { m_honor = 228 / 2; }
                        playerResult.SetEarnedHonor((short)((m_honor * 1.75) / 2),
                               CalculateEarnedDishonor(playerResult.Fighter));
                    }
                    else
                    {
                        if (m_honor < -228) { m_honor = -228; }
                        playerResult.SetEarnedHonor((short)(m_honor * 2.20),
                                CalculateEarnedDishonor(playerResult.Fighter));
                    }
                }
                ...
                else
                {
                    ...
                    {
                        if (m_honor > 228) { m_honor = 228; }
                        playerResult.SetEarnedHonor((short)(m_honor * 1.75),
                        CalculateEarnedDishonor(playerResult.Fighter));
                    }
                    else
                    {
                ...
                MongoLogger.Instance.Insert("logs_agress", document);
            }
        ...
        private void CalculateEarnedRank(FightPlayerResult result)
        {
            if (Winners == result.Fighter.Team)
            {
                ...
                else
                {
                    if (result.Character.CharacterRankId == 1)
                    {
                        result.Loot.AddItem(10275, 5); // Calyston
                    }
                    else if (result.Character.CharacterRankId == 2)
                    {
        ...
        private void CalculateEarnedExp(FightPlayerResult result)
        {
            if (Winners == result.Fighter.Team)
            {
                ...
                #region Level 151 ~ 200
                /* Level 151 ~ 200 */
                else if (characterLevel >= 151 && characterLevel <= 255)
                {
                    if (fightTime <= 300)
                    {
                        result.AddEarnedExperience(earnedEXPMatrix[2, 0]);
            ...
            if (target != null)
            {
                ...
                if (Winners == result.Fighter.Team)
                {
                    ...
                    if (characterLevel <= 50)
                    {
                        ...
                        if (fightTime <= 300)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[0, 0];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[0, 0]);
                        }

                        else if (fightTime > 301 && fightTime <= 600)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[0, 1];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[0, 1]);
                        }

                        else if (fightTime >= 601)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[0, 2];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[0, 2]);
                        }
                    }
                    #endregion
                    ...
                    else if (characterLevel >= 51 && characterLevel <= 100)
                    {
                        if (fightTime <= 300)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[1, 0];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[1, 0]);
                        }

                        else if (fightTime > 301 && fightTime <= 600)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[1, 1];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[1, 1]);
                        }

                        else if (fightTime >= 601)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[1, 2];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[1, 2]);
                        }
                    ...
                    else if (characterLevel >= 101 && characterLevel <= 150)
                    {
                        if (fightTime <= 300)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[2, 0];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[2, 0]);
                        }

                        else if (fightTime > 301 && fightTime <= 600)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[2, 1];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[2, 1]);
                        }

                        else if (fightTime >= 601)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[2, 2];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[2, 2]);
                        }
                    ...
                    else if (characterLevel >= 151 && characterLevel <= 255)
                    {
                        if (fightTime <= 300)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[3, 0];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[3, 0]);
                        }

                        else if (fightTime > 301 && fightTime <= 600)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[3, 1];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[3, 1]);
                        }

                        else if (fightTime >= 601)
                        {
                            result.Loot.Kamas += earnedKamasMatrix[3, 2];
                            result.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[3, 2]);
                        }
                    ...
                    {
                        case "fr":
                            result.Character.SendServerMessage("Vous avez gagné, félicitations!");
                            break;
                        case "es":
                            result.Character.SendServerMessage("Has ganado, felicitaciones !");
                            break;
                        case "en":
                            result.Character.SendServerMessage("You won, congratulations!");
                            break;
                        default:
                            result.Character.SendServerMessage("Você ganhou, parabéns!");
                            break;
                    }
                    result.Character.Teleport(result.Character.MapBattleField, result.Character.CellBattleField);
                }
                ...
                if (pvpSeek.Effects.FirstOrDefault(x => x.EffectId == EffectsEnum.Effect_Seek) is EffectString seekEffect)
                {
                    ...
                    if (target != null)
                    {
                        ...
                        if (Winners == result.Fighter.Team)
                        {
                            ...
                            #endregion
                            if (result.Character.AlignmentSide == AlignmentSideEnum.ALIGNMENT_ANGEL)
                                result.Loot.AddItem((int)ItemIdEnum.PEVETON_10275, 1);
                            else if (result.Character.AlignmentSide == AlignmentSideEnum.ALIGNMENT_EVIL)
                                result.Loot.AddItem((int)ItemIdEnum.PEVETON_10275, 1);
                            ...
                            switch (result.Character.Account.Lang)
                            {
                                case "fr":
                                    ...
                                    break;
                                case "es":
                                    result.Character.SendServerMessage("Has ganado el combate, felicitaciones !");
                                    break;
                                case "en":
                                    result.Character.SendServerMessage("You won the fight, congratulations!");
                                    break;
                                default:
                                    result.Character.SendServerMessage("Você venceu a luta, parabéns!");
                                    break;
                            }
                        }
                        ...
                        else
                        {
                            ...
                            if (targeLevel <= 50)
                            {
                                if (fightTime <= 300)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[0, 0];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[0, 0]);
                                }

                                else if (fightTime > 301 && fightTime <= 600)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[0, 1];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[0, 1]);
                                }

                                else if (fightTime >= 601)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[0, 2];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[0, 2]);
                                }
                            }
                            #endregion
                            ...
                            else if (targeLevel >= 51 && targeLevel <= 100)
                            {
                                if (fightTime <= 300)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[1, 0];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[1, 0]);
                                }

                                else if (fightTime > 301 && fightTime <= 600)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[1, 1];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[1, 1]);
                                }

                                else if (fightTime >= 601)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[1, 2];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[1, 2]);
                                }
                            ...
                            else if (targeLevel >= 101 && targeLevel <= 150)
                            {
                                if (fightTime <= 300)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[2, 0];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[2, 0]);
                                }

                                else if (fightTime > 301 && fightTime <= 600)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[2, 1];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[2, 1]);
                                }

                                else if (fightTime >= 601)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[2, 2];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[2, 2]);
                                }
                            ...
                            #region Level 151 ~ 200
                            /* Level 151 ~ 200 */
                            else if (targeLevel >= 151 && targeLevel <= 255)
                            {
                                if (fightTime <= 300)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[3, 0];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[3, 0]);
                                }

                                else if (fightTime > 301 && fightTime <= 600)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[3, 1];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[3, 1]);
                                }

                                else if (fightTime >= 601)
                                {
                                    target.Loot.Kamas += earnedKamasMatrix[3, 2];
                                    target.Loot.AddItem((int)ItemIdEnum.KOLIZETON_12736, (uint)earnedPvMatrix[3, 2]);
                                }
                            }
                            ...
                            if (result.Character.AlignmentSide == AlignmentSideEnum.ALIGNMENT_ANGEL)
                                result.Loot.AddItem((int)ItemIdEnum.KAMA_ARGENTE_EN_CHOCOLAT_12839, 1);
                            else if (result.Character.AlignmentSide == AlignmentSideEnum.ALIGNMENT_EVIL)
                                result.Loot.AddItem((int)ItemIdEnum.KAMA_BRONZE_EN_CHOCOLAT_12838, 1);
        ...
        public short CalculateEarnedHonor(CharacterFighter character)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        if (QtdVencedores == 1 && QtdPerdedores == 1
                            && TotalNivelVencedores - TotalNivelPerdedores < (TotalNivelVencedores > 200 ? 50 : 20))
                        {
                            passar = true;
                        }
        ...
        //                            if (TotalNivelVencedores > TotalNivelPerdedores)
        //                                return result = ((short)(((100 * (TotalNivelPerdedores)) / 235) * 60));
        //                            else
        //                                return result = ((short)(((100 * (TotalNivelVencedores)) / 235) * 60));
        //                        }
        //                        else
        //                        {
        //                            if (TotalNivelVencedores > TotalNivelPerdedores)
        //                                return result = ((short)(((100 * (TotalNivelPerdedores)) / 235) * (_loser1.Honor * 0.05)));
        //                            else
        //                                return result = ((short)(((100 * (TotalNivelVencedores)) / 235) * (_loser1.Honor * 0.05)));
        ...
        //                    //passar = true;
        //                    if(TotalNivelVencedores> TotalNivelPerdedores)
        //                        return result = ((short)-(((100*(TotalNivelPerdedores)) / 235)*((character.Character.Honor * 10) / 100)));
        //                    else
        //                        return result = ((short)-(((100 * (TotalNivelVencedores)) / 235) * ((character.Character.Honor * 10) / 100)));
        //                }
