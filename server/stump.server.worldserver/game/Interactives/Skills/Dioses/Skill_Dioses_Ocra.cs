...
{
    [Discriminator("Dioses_ocra", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_ocra : CustomSkill
    {
        public Skill_Dioses_ocra(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_ocra.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_ocra.Instance.RecordDiosesocra(character);
