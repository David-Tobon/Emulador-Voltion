...
{
    [Discriminator("Dioses_panda", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_Panda : CustomSkill
    {
        public Skill_Dioses_Panda(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_Panda.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_Panda.Instance.RecordDiosesPanda(character);
