...
{
    [Discriminator("Dioses_selotrop", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_selotrop : CustomSkill
    {
        public Skill_Dioses_selotrop(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_selotrop.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_selotrop.Instance.RecordDiosesselotrop(character);
