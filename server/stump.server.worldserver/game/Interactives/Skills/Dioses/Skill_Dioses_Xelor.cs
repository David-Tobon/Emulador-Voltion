...
{
    [Discriminator("Dioses_xelor", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_xelor : CustomSkill
    {
        public Skill_Dioses_xelor(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_xelor.Instance.GetCharacterDioses(character);

            if (miniGame != null)
            {
                if (miniGame.Tiempo_Dios != null && miniGame.Tiempo_Dios.Date == DateTime.Now.Date)
                {
                    character.OpenPopup("Solo puedes dirigir tus palabras de fé a este Dios Una Vez al Dia. <br> ¡Vuelve Mañana!");
                    return -1;
                }
            }
            ...
            Manager_Dioses_xelor.Instance.RecordDiosesxelor(character);
