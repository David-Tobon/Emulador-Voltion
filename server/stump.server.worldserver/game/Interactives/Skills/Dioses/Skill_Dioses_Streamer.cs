...
{
    [Discriminator("Dioses_streamer", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_streamer : CustomSkill
    {
        public Skill_Dioses_streamer(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_streamer.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_streamer.Instance.RecordDiosesstreamer(character);
