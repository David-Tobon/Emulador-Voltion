...
{
    [Discriminator("Dioses_yopuka", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_yopuka : CustomSkill
    {
        public Skill_Dioses_yopuka(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_yopuka.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_yopuka.Instance.RecordDiosesyopuka(character);
