...
{
    [Discriminator("Dioses_zurcarak", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_zurcarak : CustomSkill
    {
        public Skill_Dioses_zurcarak(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_zurcarak.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_zurcarak.Instance.RecordDioseszurcarak(character);
