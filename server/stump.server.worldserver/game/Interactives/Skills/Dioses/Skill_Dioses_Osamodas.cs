...
{
    [Discriminator("Dioses_osamodas", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_osamodas : CustomSkill
    {
        public Skill_Dioses_osamodas(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_osamodas.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_osamodas.Instance.RecordDiosesosamodas(character);
