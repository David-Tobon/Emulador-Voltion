...
{
    [Discriminator("Dioses_hipermago", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_hipermago : CustomSkill
    {
        public Skill_Dioses_hipermago(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_hipermago.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_hipermago.Instance.RecordDioseshipermago(character);
