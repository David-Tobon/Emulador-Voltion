...
{
    [Discriminator("Dioses_feca", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_feca : CustomSkill
    {
        public Skill_Dioses_feca(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_feca.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_feca.Instance.RecordDiosesfeca(character);
