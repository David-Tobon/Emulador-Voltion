...
{
    [Discriminator("Dioses_sram", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_sram : CustomSkill
    {
        public Skill_Dioses_sram(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_sram.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_sram.Instance.RecordDiosessram(character);
