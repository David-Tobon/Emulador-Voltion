...
{
    [Discriminator("Dioses_sadida", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_sadida : CustomSkill
    {
        public Skill_Dioses_sadida(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_sadida.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_sadida.Instance.RecordDiosessadida(character);
