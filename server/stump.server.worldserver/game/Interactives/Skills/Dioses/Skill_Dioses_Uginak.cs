...
{
    [Discriminator("Dioses_uginak", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_uginak : CustomSkill
    {
        public Skill_Dioses_uginak(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_uginak.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_uginak.Instance.RecordDiosesuginak(character);
