...
{
    [Discriminator("Dioses_aniripsa", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_aniripsa : CustomSkill
    {
        public Skill_Dioses_aniripsa(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_aniripsa.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_aniripsa.Instance.RecordDiosesaniripsa(character);
