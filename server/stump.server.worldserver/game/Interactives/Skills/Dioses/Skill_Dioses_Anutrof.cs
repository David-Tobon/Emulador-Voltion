...
{
    [Discriminator("Dioses_anutrof", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_anutrof : CustomSkill
    {
        public Skill_Dioses_anutrof(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_anutrof.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_anutrof.Instance.RecordDiosesanutrof(character);
