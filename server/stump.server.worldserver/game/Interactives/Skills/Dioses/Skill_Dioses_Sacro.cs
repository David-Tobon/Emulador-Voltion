...
{
    [Discriminator("Dioses_sacro", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_sacro : CustomSkill
    {
        public Skill_Dioses_sacro(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_sacro.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_sacro.Instance.RecordDiosessacro(character);
