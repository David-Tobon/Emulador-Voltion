...
{
    [Discriminator("Dioses_zobal", typeof(Skill), typeof(int), typeof(InteractiveCustomSkillRecord), typeof(InteractiveObject))]
    public class Skill_Dioses_zobal : CustomSkill
    {
        public Skill_Dioses_zobal(int id, InteractiveCustomSkillRecord skillTemplate, InteractiveObject interactiveObject)
        ...
        public override int StartExecute(Character character)
        {
            ...
            var miniGame = Manager_Dioses_zobal.Instance.GetCharacterDioses(character);
            ...
            Manager_Dioses_zobal.Instance.RecordDioseszobal(character);
