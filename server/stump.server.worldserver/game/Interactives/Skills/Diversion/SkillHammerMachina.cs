    ...
    public class SkillHammerMachina : CustomSkill
    {
        ...
        public override int StartExecute(Character character)
        {
            ...
            if(miniGame != null)
            {
                ...
                {
                    character.OpenPopup("El Minijuego esta disponible una Vez al Dia. <br> ¡ Prueba tu suerte mañana !");
                    return -1;
                }
            }            
            ...
            {
                character.OpenPopup("Debes equiparte un martillo para poder Jugar.");
                return -1;
            }
            ...
            character.OpenPopup("La maquina muestra puntuación de  " + nbr + " !<br>Por lo tanto Gana " + nbr + " Ficha Feria de Troll <br> ¡Felicitaciones!");
