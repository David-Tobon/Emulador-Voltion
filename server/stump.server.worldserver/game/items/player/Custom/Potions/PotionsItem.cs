...
namespace Stump.Server.WorldServer.Game.Items.Player.Custom
{
    ...
    public class CameleonMountPotion : BasePlayerItem
    {
        ...
        public override uint UseItem(int amount = 1, Cell targetCell = null, Character target = null)
        {
            if (Owner.IsRiding)
            {
                Owner.SendServerMessage("Debes desmontarte para usar esta poción.", System.Drawing.Color.DarkOrange);
                return 0;
            }
            ...
            Owner.SendServerMessage("Enhorabuena, tu montura tiene ahora una Apariencia Camaleón.", System.Drawing.Color.DarkOrange);
            return 1;

        }
    }
    [ItemId(ItemIdEnum.POTION_D_AUTOPILOTAGE)]//potion auto piloto(auto pilot)
