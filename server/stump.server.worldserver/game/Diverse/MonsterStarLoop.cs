...
namespace Game.Vote
{
    public class MonsterStarLoop : Singleton<MonsterStarLoop>
    {
        ...
        private static int _queueRefresherElapsedTime = 2400000;//2H 7200000
        ...
        private void StartLoop()
        {
            try
            {
                ...
                World.Instance.SendAnnounce("<b>[VOLTION] :</b> Las estrellas de los monstruos han sido subidas al máximo, disfrutalas...", System.Drawing.Color.AliceBlue);
