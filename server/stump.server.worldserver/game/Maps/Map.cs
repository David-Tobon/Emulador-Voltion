...
namespace Stump.Server.WorldServer.Game.Maps
{
    ...
    {
        //[Variable(true)]
        public static int MaxMerchantsPerMap = 10;
        ...
        public void Enter(RolePlayActor actor)
        {
            ...
            if (actor is Character)
            {
                ...
                if (IsInstantiated)
                    (actor as Character).SendServerMessage("Bienvenido al Servidor, te agradecemos tu estancia dentro del juego y te recordamos que aunque no sean obligatorias, las donaciones nos ayudan a mantener el servidor en Linea. Recuerda que si quieres apoyarnos con tus donaciones, puedes comunicarte con Cualquier miembro del Staff . Gracias por Jugar <3 ");
            }
            Refresh(actor);
        }
