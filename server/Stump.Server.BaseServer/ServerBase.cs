...
namespace Stump.Server.BaseServer
{
    ...
    public abstract class ServerBase
    {
        ...
        public virtual void Initialize()
        {
            ...
            {
                Config.Create();
                logger.Info("| Archivo de Configuracipn Recibido |");
            }
            else
                Config.Load();

            logger.Info("| Iniciando Bloque de Tareas |");
            ...
            logger.Info("| Iniciando Interfaces Network |");
        ...
        public void Shutdown()
        {
            lock (this)
            {
                ...
                Console.WriteLine("La Aplicación ahora esta Terminando. Espera " + Definitions.ExitWaitTime +
                                  " Segundos para Salir o Presiona cualquier tecla para cancelar.");
                ...
                if (ConditionWaiter.WaitFor(() => Console.KeyAvailable, Definitions.ExitWaitTime * 1000, 20))
                {
                    ...
                    Thread.Sleep(500);
                    Console.WriteLine("Presiona cualquier tecla para Cancelar.");
