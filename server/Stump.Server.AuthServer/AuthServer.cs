    ...
    public class AuthServer : ServerBase<AuthServer>
    {
        ...
        public override void Initialize()
        {
            ...
            try
            {
                ...
                ConsoleBase.SetTitle($"‖ Authentification ‖ Emulador de David ‖  - {Version}");
                ...
                logger.Info("| Registrando Mensajes |");
                ...
                logger.Info("| Inciando Controlador de World Server |");
                WorldServerManager.Instance.Initialize();

                logger.Info("| Iniciando Cuentas |");
                AccountManager.Instance.Initialize();

                Task.Factory.StartNewDelayed(800, () => logger.Info("| Iniciando Anti DDOS Firewall Manager |")).Wait();

                Task.Factory.StartNewDelayed(1200, () => logger.Info("| DDOS Abierto |")).Wait();

                logger.Info("| Iniciando  Comunicacion Entre Puertos |");
        ...
        public override void Start()
        {
            ...
            logger.Info("| Conexion Entre Puertos Iniciado |");
            IpcHost.Start();

            logger.Info("| Iniciando la Interfaz del Controlador de la Consola |");
        ...
        public byte[] GetConnectionSwfPatch()
        {
            ...
            logger.Warn("SWF Parche para la conexion no encontrada ({0}", ConnectionSwfPatch);
            return null;
        }
